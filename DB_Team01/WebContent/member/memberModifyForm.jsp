<%@ page language="java" contentType="text/html; charset=EUC-KR"
	...
	System.out.println(memberid+"in memberModify");
...
<body>
	  <h1> 회원정보 변경 화면입니다. </h1>
       <form method="post" action="memberModifyPro.jsp?memberid=<%=memberid %>">
           <div id ="memberModify">
          ...
          <br/>
           <div id ="meminfosubdiv">
           <input type="submit"  value="수정" id="meminfomodibtn"><br/>
          </div>
          </div>
         </form>
</body>
